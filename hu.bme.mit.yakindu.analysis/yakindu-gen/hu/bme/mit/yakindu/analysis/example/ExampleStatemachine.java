...
public class ExampleStatemachine implements IExampleStatemachine {
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_White:
				...
				break;
			case main_region_Csapda___2_4_:
				main_region_Csapda___2_4__react(true);
				break;
			default:
				// $NullState$
			}
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_Csapda___2_4_:
			return stateVector[0] == State.main_region_Csapda___2_4_;
		default:
			return false;
		}
	}
	...
	*/
	...
	/* 'default' enter sequence for state Csapda - 2.4. */
	private void enterSequence_main_region_Csapda___2_4__default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Csapda___2_4_;
	}
	...
	/* Default exit sequence for state Csapda - 2.4. */
	private void exitSequence_main_region_Csapda___2_4_() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void exitSequence_main_region() {
		...
		case main_region_White:
			...
			break;
		case main_region_Csapda___2_4_:
			exitSequence_main_region_Csapda___2_4_();
			break;
		default:
			break;
		}
				...
				if (sCInterface.black) {
					...
					if (timeEvents[0]) {
						...
						if (sCInterface.white) {
							exitSequence_main_region_Black();
							enterSequence_main_region_Csapda___2_4__default();
						} else {
							did_transition = false;
						}
					}
	...
	private boolean main_region_Csapda___2_4__react(boolean try_transition) {
		boolean did_transition = try_transition;
